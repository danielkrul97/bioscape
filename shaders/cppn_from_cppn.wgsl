...
const BRAIN_INPUTS_SENSORY: u32 = 33u;  // V7: 27 + 2 bond inbox + 4 vibration
const BRAIN_INPUTS: u32 = 78u;          // V7: + 45 recurrent
const BRAIN_HIDDEN: u32 = 45u;
const BRAIN_OUTPUTS: u32 = 14u;         // 12 motor/morph + 2 bond message
const W1_OFFSET: u32 = 0u;
const B1_OFFSET: u32 = 3510u;
const W2_OFFSET: u32 = 3555u;
const B2_OFFSET: u32 = 4185u;
const WEIGHTS_PER_CELL: u32 = 4199u;

const NUM_W1: u32 = 3510u;     // BRAIN_HIDDEN × BRAIN_INPUTS
const NUM_B1: u32 = 45u;       // BRAIN_HIDDEN
const NUM_W2: u32 = 630u;      // BRAIN_OUTPUTS × BRAIN_HIDDEN
const NUM_B2: u32 = 14u;       // BRAIN_OUTPUTS
const QUERIES_PER_CHILD: u32 = 4199u; // NUM_W1 + NUM_B1 + NUM_W2 + NUM_B2
