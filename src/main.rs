...
use bioscape::{
    ...
    HAZARD_AMP, HAZARD_DRAIN_PER_SEC, HAZARD_FLOOR, INITIAL_CELLS, LEARNING_RATE,
    MATING_PHEROMONE_THRESHOLD, MATING_RADIUS, MAX_POPULATION, MAX_SPAWN_ATTEMPTS, MUTATION_CONFIG,
    PHEROMONE_BASELINE_EMIT, PHEROMONE_BRAIN_MOD, PHEROMONE_COST_PER_RATE, PHEROMONE_DECAY,
    PHEROMONE_DIFFUSION, PHEROMONE_GRID_RES, PHEROMONE_NORMALIZATION_GAIN,
    PHEROMONE_SAMPLE_EPSILON, PHYSICS_CONFIG,
