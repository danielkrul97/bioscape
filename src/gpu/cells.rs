...
pub struct CellsGpu {
    ...
    /// (signed role-need × proximity), written each tick from CPU, read by
    /// populate_inputs into brain input slot 39.
    coop_call_buf: wgpu::Buffer,
...
impl CellsGpu {
    ...
    fn with_device_inner(
        ...
        let last_inputs_buf = mk(
            "cells-last-inputs",
            n * (BRAIN_INPUTS as u64) * f,
            stor_dst_src,
        );
        let last_hidden_buf = mk(
            "cells-last-hidden",
            n * (BRAIN_HIDDEN as u64) * f,
            stor_dst_src,
        );
        let last_outputs_buf = mk(
            "cells-last-outputs",
            n * (BRAIN_OUTPUTS as u64) * f,
            stor_dst_src,
        );
        let brain_weights_buf = mk(
            "cells-brain-weights",
        ...
        let reproduce_at_energies_buf = mk("cells-reproduce-at-energies", n * f, stor_dst_src);
        ...
        queue.write_buffer(&neuron_models_buf, 0, bytemuck::cast_slice(&zero_models));
        ...
        queue.write_buffer(
            ...
            0,
            bytemuck::cast_slice(&zero_post_u32),
        );
        ...
        let coop_call_buf = mk("cells-coop-call", n * f, stor_dst_src);
        // Motor.
    ...
    pub fn last_inputs_buffer(&self) -> &wgpu::Buffer {
        &self.last_inputs_buf
    }
    pub fn last_hidden_buffer(&self) -> &wgpu::Buffer {
        &self.last_hidden_buf
    }
    pub fn last_outputs_buffer(&self) -> &wgpu::Buffer {
        &self.last_outputs_buf
    }
    pub fn brain_weights_buffer(&self) -> &wgpu::Buffer {
        &self.brain_weights_buf
    }
    /// Wave 7: per-cell eligibility-trace buffer (parallel to brain weights).
    pub fn brain_traces_buffer(&self) -> &wgpu::Buffer {
        &self.brain_traces_buf
    }
    /// Sprint 195: per-cell whisker spring-damper state (12 f32/cell).
    pub fn whisker_state_buffer(&self) -> &wgpu::Buffer {
        &self.whisker_state_buf
    }
    pub fn velocities_buffer(&self) -> &wgpu::Buffer {
        &self.velocities_buf
    }
    pub fn xoshiro_state_buffer(&self) -> &wgpu::Buffer {
        &self.xoshiro_state_buf
    }
    pub fn rewards_buffer(&self) -> &wgpu::Buffer {
        &self.rewards_buf
    }
    pub fn learning_rates_buffer(&self) -> &wgpu::Buffer {
        &self.learning_rates_buf
    }
    pub fn trace_decays_buffer(&self) -> &wgpu::Buffer {
        &self.trace_decays_buf
    }
    pub fn reproduce_at_energies_buffer(&self) -> &wgpu::Buffer {
        &self.reproduce_at_energies_buf
    }
    pub fn membrane_buffer(&self) -> &wgpu::Buffer {
        &self.membrane_buf
    }
    pub fn recovery_buffer(&self) -> &wgpu::Buffer {
        &self.recovery_buf
    }
    pub fn neuron_models_buffer(&self) -> &wgpu::Buffer {
        &self.neuron_models_buf
    }
    pub fn pre_spike_times_buffer(&self) -> &wgpu::Buffer {
        &self.pre_spike_times_buf
    }
    pub fn post_spike_times_buffer(&self) -> &wgpu::Buffer {
        &self.post_spike_times_buf
    }
    pub fn pre_trace_buffer(&self) -> &wgpu::Buffer {
        &self.pre_trace_buf
    }
    pub fn post_trace_buffer(&self) -> &wgpu::Buffer {
        &self.post_trace_buf
    }
    /// `populate_inputs` metadata buffer accessors.
    pub fn energy_buffer(&self) -> &wgpu::Buffer {
        &self.energy_buf
    }
    pub fn heading_buffer(&self) -> &wgpu::Buffer {
        &self.heading_buf
    }
    pub fn pitch_buffer(&self) -> &wgpu::Buffer {
        &self.pitch_buf
    }
    pub fn damage_accum_buffer(&self) -> &wgpu::Buffer {
        &self.damage_accum_buf
    }
    pub fn max_speed_buffer(&self) -> &wgpu::Buffer {
        &self.max_speed_buf
    }
    pub fn eff_radius_buffer(&self) -> &wgpu::Buffer {
        &self.eff_radius_buf
    }
    pub fn mass_buffer(&self) -> &wgpu::Buffer {
        &self.mass_buf
    }
    pub fn coop_call_buffer(&self) -> &wgpu::Buffer {
        &self.coop_call_buf
    }
    pub fn bonded_inbox_buffer(&self) -> &wgpu::Buffer {
        &self.bonded_inbox_buf
    }
    /// Motor accessors. `turn_rate` is read-only; angular/pitch velocities
    /// are read-write.
    pub fn turn_rate_buffer(&self) -> &wgpu::Buffer {
        &self.turn_rate_buf
    }
    pub fn angular_velocity_buffer(&self) -> &wgpu::Buffer {
        &self.angular_velocity_buf
    }
    pub fn pitch_velocity_buffer(&self) -> &wgpu::Buffer {
        &self.pitch_velocity_buf
    }
    /// Step accessors.
    pub fn position_buffer(&self) -> &wgpu::Buffer {
        &self.position_buf
    }
    pub fn age_buffer(&self) -> &wgpu::Buffer {
        &self.age_buf
    }
    pub fn cooldown_buffer(&self) -> &wgpu::Buffer {
        &self.cooldown_buf
    }
    pub fn body_dims_buffer(&self) -> &wgpu::Buffer {
        &self.body_dims_buf
    }
    pub fn aux_buffer(&self) -> &wgpu::Buffer {
        &self.aux_buf
    }
    ...
    pub fn upload_positions(&self, positions: &[[f32; 3]]) {
        ...
        // repacking Vec.
        self.queue
            .write_buffer(&self.position_buf, 0, bytemuck::cast_slice(positions));
    }
    ...
    pub fn download_full_copy_into(&self, encoder: &mut wgpu::CommandEncoder, n: usize) {
        if n == 0 {
            return;
        }
    ...
    pub fn download_full_read_into(
        ...
        for s in [
            &i_s, &h_s, &o_s, &v_s, &a_s, &p_s, &pos_s, &age_s, &cd_s, &e_s,
        ] {
    ...
    pub fn upload_turn_rates(&self, turn_rates: &[f32]) {
        self.queue
            .write_buffer(&self.turn_rate_buf, 0, bytemuck::cast_slice(turn_rates));
    }
    ...
    pub fn upload_angular_pitch(&self, angular: &[f32], pitches: &[f32]) {
        ...
        self.queue
            .write_buffer(&self.angular_velocity_buf, 0, bytemuck::cast_slice(angular));
        self.queue
            .write_buffer(&self.pitch_velocity_buf, 0, bytemuck::cast_slice(pitches));
    }
    ...
    pub fn download_motor_state(&self, n: usize) -> (Vec<[f32; 3]>, Vec<f32>, Vec<f32>) {
        if n == 0 {
    ...
    pub fn upload_metadata(
        ...
        self.queue.write_buffer(
            &self.damage_accum_buf,
            0,
            bytemuck::cast_slice(damage_accums),
        );
        self.queue
            .write_buffer(&self.max_speed_buf, 0, bytemuck::cast_slice(max_speeds));
        self.queue
            .write_buffer(&self.eff_radius_buf, 0, bytemuck::cast_slice(eff_radii));
        self.queue
            .write_buffer(&self.mass_buf, 0, bytemuck::cast_slice(masses));
    }
        ...
        I: IntoIterator<Item = &'a Brain>,
    {
        ...
        self.queue
            .write_buffer(&self.brain_weights_buf, 0, bytemuck::cast_slice(&packed));
    }
    ...
    pub fn upload_inputs(&self, inputs: &[[f32; BRAIN_INPUTS]]) {
        self.queue
            .write_buffer(&self.last_inputs_buf, 0, bytemuck::cast_slice(inputs));
    }

    pub fn upload_coop_call_signals(&self, sigs: &[f32]) {
        self.queue
            .write_buffer(&self.coop_call_buf, 0, bytemuck::cast_slice(sigs));
    }

    pub fn upload_bonded_inboxes(&self, inboxes: &[[f32; N_BOND_MSG_CHANNELS]]) {
        self.queue
            .write_buffer(&self.bonded_inbox_buf, 0, bytemuck::cast_slice(inboxes));
    }

    pub fn upload_velocities(&self, velocities: &[[f32; 3]]) {
        self.queue
            .write_buffer(&self.velocities_buf, 0, bytemuck::cast_slice(velocities));
    }
    ...
    pub fn zero_persistent_state(&self) {
        ...
        self.queue
            .write_buffer(&self.brain_traces_buf, 0, &zeros[..traces_bytes]);
        self.queue
            .write_buffer(&self.last_inputs_buf, 0, &zeros[..inputs_bytes]);
        self.queue
            .write_buffer(&self.last_hidden_buf, 0, &zeros[..hidden_bytes]);
        self.queue
            .write_buffer(&self.last_outputs_buf, 0, &zeros[..outputs_bytes]);
        self.queue
            .write_buffer(&self.rewards_buf, 0, &zeros[..rewards_bytes]);
        self.queue
            .write_buffer(&self.bonded_inbox_buf, 0, &zeros[..inbox_bytes]);
    }
        ...
        I: IntoIterator<Item = u64>,
    {
        ...
        self.queue
            .write_buffer(&self.xoshiro_state_buf, 0, bytemuck::cast_slice(&state));
    }
