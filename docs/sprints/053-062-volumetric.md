...
## Sprinty 63+ — viz `docs/sprints/063-072-scaleup.md`

Sprint 63 (step on GPU) + Sprint 64 (z=50, pop=2500) přesunuty do dalšího
10-sprintového dokumentu (CLAUDE.md naming convention).
